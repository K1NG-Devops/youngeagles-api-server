...
('free', 'limited_storage', 100, TRUE), -- 100MB
('free', 'ads_enabled', NULL, TRUE),

-- Student plan features
('student', 'basic_homework', NULL, TRUE), -- Unlimited
('student', 'basic_activities', NULL, TRUE), -- Unlimited
...
('institution', 'multiple_children', NULL, TRUE), -- Unlimited
